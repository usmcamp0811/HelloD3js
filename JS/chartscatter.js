...
//         d.physicalstrength, d.fearfactor, d.killingpower, d.horrorrating
//     });
// });
var horror;
var json = d3.json("../Data/scatter_plot_example_data.json", function(json) {
    forEach(json);
    // console.log(horror);
});

console.log("shit", horror[0]);
//Set constants
function render(horror) {
    var w = 420,
        h = 400,
        padding = 30;
